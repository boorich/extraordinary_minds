  ...
  return (
    <div className="text-slate-100">
      ...
      <div className="professional-gradient">
        <main id="main-content" className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16 relative" role="main">
          <div className="relative z-10">
            ...
            {/* Chat Interface */}
            <div className="max-w-4xl mx-auto mb-16 bg-slate-900/40 rounded-2xl p-8 backdrop-blur-sm border border-white/10 shadow-2xl">
        ...
        <footer className="bg-slate-900/40 backdrop-blur-sm mt-16" role="contentinfo">
