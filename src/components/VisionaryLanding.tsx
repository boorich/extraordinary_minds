    ...
    <div className="text-slate-100">
      ...
      <div className="professional-gradient">
        ...
        <div className="h-[calc(100vh-4rem)] flex flex-col">
          <div className="flex-1 max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16 flex flex-col justify-center">
            {/* Hero Section */}
            ...
            {/* Chat Interface */}
            <div className="max-w-4xl mx-auto w-full bg-slate-900/40 rounded-2xl p-8 backdrop-blur-sm border border-white/10 shadow-2xl">
        ...
        <footer className="bg-slate-900/40 backdrop-blur-sm" role="contentinfo">
